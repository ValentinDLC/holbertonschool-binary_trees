...
static int tree_height(const binary_tree_t *tree)
{
    ...
    /* Recursively get thew height of subtrees */
    count_height = (tree_height(tree->left) > tree_height(tree->right)) ? tree_height(tree->left) : tree_height(tree->right);
...
int binary_tree_balance(const binary_tree_t *tree)
{
    ...
    /* Get height of subtrees and balance factor */
